...
const Blogs = () => {
    return (
        <div className='px-48'>
            <div>
                <h3 className='text-2xl  text-secondary font-bold'>How will you improve the performance of a React Application?</h3>
            ...
            <div>
                <h3 className='text-2xl  text-secondary font-bold'>What are the different ways to manage a state in a React application?</h3>
            ...
            <div>
                <h3 className='text-2xl text-secondary font-bold'>How does prototypical inheritance work?</h3>
            ...
            <div>
                <h3 className='text-2xl text-secondary font-bold'> Why you do not set the state directly in React. For example, if you have const [products, setProducts] = useState([]). Why you do not set products = [...] instead, you use the setProducts</h3>
            ...
            <div>
                <h3 className='text-2xl text-secondary font-bold'>You have an array of products. Each product has a name, price, description, etc. How will you implement a search to find products by name?</h3>
            ...
            <div>
                <h3 className='text-2xl text-secondary font-bold'>What is a unit test? Why should write unit tests?</h3>
